...
AI_MODEL_SUGGESTIONS = {
    "OpenAI"            : ["gpt-5.4-mini", "gpt-5.5", "gpt-4-turbo"],
    "Anthropic (Claude)": ["claude-sonnet-4-6", "claude-opus-4-7",
                           "claude-haiku-4-5-20251001"],
    "Groq"              : ["llama-3.1-8b-instant", "openai/gpt-oss-20b", "llama-3.3-70b-versatile", "whisper-large-v3"],
    "Google Gemini"     : ["gemini-3-flash-preview", "gemini-3.1-pro-preview", "gemini-3.1-flash-lite-preview"],
}

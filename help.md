...
│
├── config.py                    ← Bank Recon global settings \& defaults
├── data\_ingestion.py            ← Bank file loading \& column preprocessing
├── engine.py                    ← Bank rule-based matching engine
├── inferences.py                ← Bank analytics, KPIs \& AI context builder
│
├── icr\_config.py                ← ICR global settings \& defaults
├── icr\_data.py                  ← IC file loading \& column preprocessing
├── icr\_engine.py                ← ICR rule-based matching engine (8 rules)
├── icr\_inferences.py            ← ICR analytics, entity matrix \& AI context builder
│
...
*Add team member credits, version history, and changelog below this line:*
...
Version History:
  v1.0  —  \[Date]  —  Initial release
           Bank Reconciliation module (10 rules)
           ICR module (8 rules)
           Multi-provider AI Agent (OpenAI, Claude, Groq, Gemini)
```
...
*Reconciliation Modules — v1.0 · Built with Plotly Dash ·*
